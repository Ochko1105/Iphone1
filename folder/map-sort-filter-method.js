...
result3=findprice(data)
console.log("bodlogo3",result3)
// 4. "Computers" категорийн бүтээгдэхүүнүүдийг буцаадаг функц бич.
function findcategor(products) {
    let category= products.filter((products)=>{
...
result4=findcategor(data)
console.log("bodlogo4",result4)
// 5. Тухайн брэндийн нэрээр бүтээгдэхүүнүүдийг шүүдэг функц бич.
function findbrand(products,brandname) {
    let brand= products.filter((products)=>{
        if(products.brand===brandname){
            return products
        }
